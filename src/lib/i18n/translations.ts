...
const en: Dict = {
  ...
  "trd.resume": "Resume",
  "trd.pause": "Pause",
  "trd.pauseTitle": "Pause treatment",
  "trd.pauseDesc":
    "Doses in the paused period are skipped (not recovered) and shown as paused. Leave the date empty to pause indefinitely.",
  "trd.pauseUntil": "Pause until",
  "trd.pauseUntilHint": "Empty = pause indefinitely (resume manually).",
  "trd.pauseUntilHintMax": "No later than {date} (end of treatment).",
  "trd.pauseUntilAction": "Pause until date",
  "trd.pauseIndefinite": "Pause indefinitely",
  "trd.pausePast": "Pick a date in the future.",
  "trd.pauseTooLate": "The treatment ends on {date}; pick an earlier date.",
  "trd.pausedUntil": "until {date}",
  "trd.pausedIndef": "indefinitely",
  ...
  "trans.camera": "Camera info",
  "trans.cameraHint":
    "Record your camera setup so future photos can be shot the same way.",
  "trans.cameraBody": "Camera",
  "trans.lens": "Lens",
  "trans.focalLength": "Focal length",
  "trans.subjectDistance": "Subject–camera distance",
  "trans.flash": "Flash",
  "trans.flashPower": "Flash power",
  "trans.aperture": "Aperture",
  "trans.diaphragm": "Diaphragm",
  "trans.shutterSpeed": "Shutter speed",
  "trans.iso": "ISO",
  "trans.whiteBalance": "White balance",
  "trans.cameraElevation": "Camera elevation",
...
const es: Dict = {
  ...
  "trd.resume": "Reanudar",
  "trd.pause": "Pausar",
  "trd.pauseTitle": "Pausar tratamiento",
  "trd.pauseDesc":
    "Las dosis del periodo pausado se saltan (no se recuperan) y se muestran como pausadas. Deja la fecha vacía para pausar indefinidamente.",
  "trd.pauseUntil": "Pausar hasta",
  "trd.pauseUntilHint": "Vacío = pausar indefinidamente (reanudas a mano).",
  "trd.pauseUntilHintMax": "No más tarde del {date} (fin del tratamiento).",
  "trd.pauseUntilAction": "Pausar hasta la fecha",
  "trd.pauseIndefinite": "Pausar indefinidamente",
  "trd.pausePast": "Elige una fecha futura.",
  "trd.pauseTooLate": "El tratamiento termina el {date}; elige una fecha anterior.",
  "trd.pausedUntil": "hasta el {date}",
  "trd.pausedIndef": "indefinidamente",
  ...
  "trans.camera": "Información de cámara",
  "trans.cameraHint":
    "Registra la configuración de tu cámara para repetir la misma toma en el futuro.",
  "trans.cameraBody": "Cámara",
  "trans.lens": "Lente",
  "trans.focalLength": "Distancia focal",
  "trans.subjectDistance": "Distancia sujeto–cámara",
  "trans.flash": "Flash",
  "trans.flashPower": "Potencia del flash",
  "trans.aperture": "Apertura",
  "trans.diaphragm": "Diafragma",
  "trans.shutterSpeed": "Velocidad de obturación",
  "trans.iso": "ISO",
  "trans.whiteBalance": "Balance de blancos",
  "trans.cameraElevation": "Elevación de la cámara",
