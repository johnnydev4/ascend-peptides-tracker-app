...
const en: Dict = {
  ...
  "dash.lastSite": "Last site · {name}",
  "dash.noSiteYet": "No site recorded yet",
  ...
  // Syringe inventory
  "syringe.title": "Syringe stock",
  "syringe.unit": "syringes left",
  "syringe.typeLabel": "Type · {type}",
  "syringe.noType": "No type set",
  "syringe.increment": "Add a syringe",
  "syringe.decrement": "Remove a syringe",
  "syringe.lowStock": "Running low — {count} left",
  "syringe.outOfStock": "You're out of syringes",
  "syringe.reminderOn": "Reminder on when {threshold} or fewer",
  "syringe.editTitle": "Syringe stock",
  "syringe.countLabel": "Syringes on hand",
  "syringe.typeSelect": "Syringe type",
  "syringe.noneOption": "Not set",
  "syringe.customOption": "Other…",
  "syringe.customLabel": "Custom type",
  "syringe.customPlaceholder": "e.g. 31G 8mm",
  "syringe.noteLabel": "Note",
  "syringe.notePlaceholder": "e.g. brand, box location, reorder link…",
  "syringe.reminderLabel": "Low-stock reminder",
  "syringe.reminderHint": "Warn me while the app is open when I'm running low.",
  "syringe.thresholdLabel": "Warn when at or below",
  "syringe.notifTitle": "Syringe stock low",
  "syringe.notifLow": "Only {count} syringes left — time to restock.",
  "syringe.notifOut": "You're out of syringes — time to restock.",
...
const es: Dict = {
  ...
  "dash.lastSite": "Última zona · {name}",
  "dash.noSiteYet": "Sin zona registrada aún",
  ...
  // Inventario de jeringas
  "syringe.title": "Stock de jeringas",
  "syringe.unit": "jeringas restantes",
  "syringe.typeLabel": "Tipo · {type}",
  "syringe.noType": "Sin tipo definido",
  "syringe.increment": "Añadir una jeringa",
  "syringe.decrement": "Quitar una jeringa",
  "syringe.lowStock": "Quedan pocas — {count} restantes",
  "syringe.outOfStock": "Te quedaste sin jeringas",
  "syringe.reminderOn": "Aviso activo cuando queden {threshold} o menos",
  "syringe.editTitle": "Stock de jeringas",
  "syringe.countLabel": "Jeringas disponibles",
  "syringe.typeSelect": "Tipo de jeringa",
  "syringe.noneOption": "Sin definir",
  "syringe.customOption": "Otra…",
  "syringe.customLabel": "Tipo personalizado",
  "syringe.customPlaceholder": "ej. 31G 8mm",
  "syringe.noteLabel": "Nota",
  "syringe.notePlaceholder": "ej. marca, dónde están, link para reponer…",
  "syringe.reminderLabel": "Aviso de stock bajo",
  "syringe.reminderHint": "Avísame con la app abierta cuando queden pocas.",
  "syringe.thresholdLabel": "Avisar cuando queden o menos de",
  "syringe.notifTitle": "Quedan pocas jeringas",
  "syringe.notifLow": "Solo quedan {count} jeringas — hora de reponer.",
  "syringe.notifOut": "Te quedaste sin jeringas — hora de reponer.",
