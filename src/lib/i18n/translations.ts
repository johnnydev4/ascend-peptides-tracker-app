...
const en: Dict = {
  ...
  // Needle inventory
  "needle.title": "Needle stock",
  "needle.unit": "needles left",
  "needle.typeLabel": "Type · {type}",
  "needle.noType": "No type set",
  "needle.increment": "Add a needle",
  "needle.decrement": "Remove a needle",
  "needle.lowStock": "Running low — {count} left",
  "needle.outOfStock": "You're out of needles",
  "needle.reminderOn": "Reminder on when {threshold} or fewer",
  "needle.editTitle": "Needle stock",
  "needle.countLabel": "Needles on hand",
  "needle.typeSelect": "Needle type",
  "needle.noneOption": "Not set",
  "needle.customOption": "Other…",
  "needle.customLabel": "Custom type",
  "needle.customPlaceholder": "e.g. 31G 8mm",
  "needle.noteLabel": "Note",
  "needle.notePlaceholder": "e.g. brand, box location, reorder link…",
  "needle.reminderLabel": "Low-stock reminder",
  "needle.reminderHint": "Warn me while the app is open when I'm running low.",
  "needle.thresholdLabel": "Warn when at or below",
  "needle.notifTitle": "Needle stock low",
  "needle.notifLow": "Only {count} needles left — time to restock.",
  "needle.notifOut": "You're out of needles — time to restock.",
...
const es: Dict = {
  ...
  // Inventario de agujas
  "needle.title": "Stock de agujas",
  "needle.unit": "agujas restantes",
  "needle.typeLabel": "Tipo · {type}",
  "needle.noType": "Sin tipo definido",
  "needle.increment": "Añadir una aguja",
  "needle.decrement": "Quitar una aguja",
  "needle.lowStock": "Quedan pocas — {count} restantes",
  "needle.outOfStock": "Te quedaste sin agujas",
  "needle.reminderOn": "Aviso activo cuando queden {threshold} o menos",
  "needle.editTitle": "Stock de agujas",
  "needle.countLabel": "Agujas disponibles",
  "needle.typeSelect": "Tipo de aguja",
  "needle.noneOption": "Sin definir",
  "needle.customOption": "Otra…",
  "needle.customLabel": "Tipo personalizado",
  "needle.customPlaceholder": "ej. 31G 8mm",
  "needle.noteLabel": "Nota",
  "needle.notePlaceholder": "ej. marca, dónde están, link para reponer…",
  "needle.reminderLabel": "Aviso de stock bajo",
  "needle.reminderHint": "Avísame con la app abierta cuando queden pocas.",
  "needle.thresholdLabel": "Avisar cuando queden o menos de",
  "needle.notifTitle": "Quedan pocas agujas",
  "needle.notifLow": "Solo quedan {count} agujas — hora de reponer.",
  "needle.notifOut": "Te quedaste sin agujas — hora de reponer.",
